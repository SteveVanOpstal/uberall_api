...
**moreHours** | [**List<Object>**](Object.md) | The location''s additional service hours, such as delivery, pickup, happy hours etc. Submitted to Google. | [optional] [default to const []]
...
**specialOpeningHours** | [**List<SpecialOpeningHours>**](SpecialOpeningHours.md) | The location''s special opening hours: e.g. <pre>[ &#123;      \"date\": \"2017-06-29\",     \"closed\": true   &#125;,    &#123;     \"date\": \"2017-06-30\",     \"from1\": \"11:00\",     \"to1\": \"14:00\",     \"from2\": \"16:00\",     \"to2\": \"20:00\"   &#125; ]</pre> Please note that having more than 2 time periods for each day is not possible. | [optional] [default to const []]
...
**categories** | [**List<Object>**](Object.md) | Required - A list of category IDs describing the location | [default to const []]
...
**attributes** | [**List<Object>**](Object.md) | The location''s Google attributes | [optional] [default to const []]
...
**paymentOptions** | [**List<Object>**](Object.md) | Payment options available at the location | [optional] [default to const []]
...
**doctorCategories** | [**List<Object>**](Object.md) | A list of category IDs for Doctor.com directory | [optional] [default to const []]
...
**openingDate** | [**DateTime**](DateTime.md) | The original opening date of the business | [optional] 
...
**customFields** | **Map<String, String>** | Custom Fields for the directory | [optional] [default to const {}]
...
**keywords** | **List<String>** | The video of the social post (can only be one) | [optional] [default to const []]
**brands** | **List<String>** | The video of the social post (can only be one) | [optional] [default to const []]
**services** | **List<String>** | The video of the social post (can only be one) | [optional] [default to const []]
**languages** | **List<String>** | The video of the social post (can only be one) | [optional] [default to const []]
**photos** | **bool** | Boolean indicating whether or not the listing has photos | [optional] 
**socialProfiles** | [**List<SocialProfile>**](SocialProfile.md) | Social profiles of the location | [optional] [default to const []]
**contentLists** | [**List<ContentList>**](ContentList.md) | Content lists shown on the listing | [optional] [default to const []]
**videos** | [**List<Video>**](Video.md) | A list of videos about the location | [optional] [default to const []]
