...
**listings** | [**Set<Listing>**](Listing.md) | Output only. List of this location''s online listings together with their sync status | [optional] [default to const {}]
**openingHours** | [**Set<OpeningHours>**](OpeningHours.md) | The location''s opening hours: e.g. <pre>[ &#123;      \"dayOfWeek\": 1,     \"closed\": false,     \"from1\": \"08:00\",     \"to1\": \"11:00\"   &#125;,    &#123;     \"dayOfWeek\": 2,     \"closed\": false,     \"from1\": \"08:00\",     \"to1\": \"11:00\",     \"from2\": \"13:00\",     \"to2\": \"21:00\"   &#125;,   &#123;     \"dayOfWeek\": 3,     \"closed\": true   &#125; ]</pre> Please note that having more than 2 time periods for each day is not possible. | [optional] [default to const {}]
**specialOpeningHours** | [**Set<SpecialOpeningHours>**](SpecialOpeningHours.md) | The location''s special opening hours: e.g. <pre>[ &#123; \"date\": \"2017-06-29\", \"closed\": true &#125;, &#123; \"date\": \"2017-06-30\", \"from1\": \"11:00\", \"to1\": \"14:00\", \"from2\": 16:00\", \"to2\": \"20:00\" &#125; ]</pre> Please note that having more than 2 time periods for each day is not possible. | [optional] [default to const {}]
...
**keywords** | **List<String>** | Keywords describing the location's activity | [optional] [default to const []]
**labels** | [**Set<Label>**](Label.md) | Labels grouping similar locations | [optional] [default to const {}]
**brands** | **List<String>** | The brands offered by the location to its customers | [optional] [default to const []]
**paymentOptions** | **Set<String>** | The payment options accepted at the location (eg. cash, bank transfer, ...) | [optional] [default to const {}]
**services** | **Set<String>** | Services offered at the location. Do not use if Content Collections is enabled. Instead use the Service Item and Collection endpoints | [optional] [default to const {}]
**languages** | **Set<String>** | The language(s) in which customers can interact with the location''s staff | [optional] [default to const {}]
**categories** | [**List<Category>**](Category.md) | Required to start location sync  - A list of category IDs describing the location | [optional] [default to const []]
...
**photos** | [**List<LocationPhoto>**](LocationPhoto.md) | The location''s photos | [optional] [default to const []]
...
**openingDate** | [**DateTime**](DateTime.md) | The date the location will first open. Must be formatted YYYY-MM-DD | [optional] 
**serviceAreas** | [**List<ServiceArea>**](ServiceArea.md) | Service areas available on the location. | [optional] [default to const []]
**callTrackingNumbers** | [**Set<CallTrackingNumber>**](CallTrackingNumber.md) | Add call tracking numbers for distribution to Google, Facebook, and Bing. The call tracking numbers must be different from the location''s primary phone number | [optional] [default to const {}]
**utms** | [**Set<UTM>**](UTM.md) | UTM parameter to be appended to the location''s website. Codes can be sent to Google, Facebook, and Bing. | [optional] [default to const {}]
**transactionLinks** | [**Set<LocationTransactionLink>**](LocationTransactionLink.md) | Links that appear on some directories for specific types of customer actions, such as food ordering, appointment setting, and booking reservations. Only available for specific business categories. | [optional] [default to const {}]
...
**features** | **Set<String>** | Output only. List of features available to the location | [optional] [default to const {}]
...
**contentLists** | **List<int>** | The content list IDs (EVENTS, PRODUCTS, MENU, PEOPLE) describing the location | [optional] [default to const []]
**missingMandatoryFields** | **Set<String>** | Output only. Compile all the fields that are currently missing but mandatory for some directories. They have to be set in the Location object, so that the Listing can be created / updated on the respective platform. List of Strings, e.g. [NAME, ZIP, PHONE] | [optional] [default to const {}]
**moreHours** | [**Set<Map<String, Object>>**](Map.md) | The location''s additional service hours, such as delivery, pickup, happy hours etc. Submitted to Google. e.g. <pre>[&#123;     \"type\": \"ONLINE_SERVICE_HOURS\",     \"hours\": [&#123;         \"dayOfWeek\": 1,         \"from1\": \"09:00\",         \"to1\": \"18:00\"     &#125;, &#123;         \"dayOfWeek\": 2,         \"from1\": \"09:00\",         \"to1\": \"13:00\"     &#125;] &#125;, &#123;     \"type\": \"ACCESS\",     \"hours\": [&#123;         \"dayOfWeek\": 1,         \"from1\": \"06:00\",         \"to1\": \"20:00\"     &#125;] &#125;]</pre> | [optional] [default to const {}]
**videos** | [**List<Video>**](Video.md) | The location''s videos | [optional] [default to const []]
...
**attributes** | [**List<AttributeWrapper>**](AttributeWrapper.md) | Google attributes | [optional] [default to const []]
...
**customFields** | [**Object**](.md) | A Map for identifying the value input for a specific custom field name on the location. Custom fields are created at the business level. <pre>   \"customFields\": [     '{'       \"name\": \"foo\",       \"value\": \"bar\"     '}',     '{'       \"name\": \"baz\",       \"value\": \"qux\"     '}'   ] </pre> | [optional] 
