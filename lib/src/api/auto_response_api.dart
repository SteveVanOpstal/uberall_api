...
class AutoResponseApi {
  ...
  const AutoResponseApi(this._dio, this._serializers);
  ...
  ///
  /// Parameters:
  /// * [businesses] - Only return Auto Response Rules identified by the business ids listed in businesses
  /// * [locations] - Only return Auto Response Rules identified by the location ids listed in locations
  /// * [excludedLocations] - List of location ids that should be excluded from the result
  /// * [page] - Used for pagination
  /// * [size] - Used for pagination
  /// * [sort] - Field to sort the results in, use created_by, date_created or id
  /// * [direction] - Direction to sort the results in, use asc for ascending sort or desc for descending sort
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<RulesResponseWrapper>> getAutoResponseRules({ 
    ...
    final _path = r'/auto-response/rules';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    RulesResponseWrapper? _responseData;
    ...
    return Response<RulesResponseWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<RuleResponseWrapper>> getAutoResponseRulesId({ 
    ...
    RuleResponseWrapper? _responseData;
    ...
    return Response<RuleResponseWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [id] - id of Auto Response Rule
  /// * [postAutoResponseRulesRequest] - Auto Response Rule to be edited
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  ///
  /// Parameters:
  /// * [postAutoResponseRulesRequest] - Auto Response Rule to be created
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  ///
  /// Parameters:
  /// * [checkConflictRequest] - A CheckConflictRequest object
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<ConflictingRulesResponseWrapper>> postAutoResponseRulesCheckConflict({ 
    ...
    final _path = r'/auto-response/rules/check-conflict';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ConflictingRulesResponseWrapper? _responseData;
    ...
    return Response<ConflictingRulesResponseWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
