...
class BatchOperationApi {
  ...
  const BatchOperationApi(this._dio, this._serializers);
  ...
  /// * [sort] - Order results by the specified field. Default is location id.
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [LocationImportListWrapper] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LocationImportListWrapper>> getBatch({ 
    int? max = 10,
    int? offset = 0,
    String? sort,
    String? order = 'asc',
    ...
    LocationImportListWrapper? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(LocationImportListWrapper),
      ) as LocationImportListWrapper;
    ...
    return Response<LocationImportListWrapper>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [id] - The uberall unique ID of the location import
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Uint8List>> getBatchIdErrorReport({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/batch/{id}/error-report'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
