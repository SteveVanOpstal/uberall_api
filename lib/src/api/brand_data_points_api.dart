...
class BrandDataPointsApi {
  ...
  const BrandDataPointsApi(this._dio, this._serializers);

  /// Unlike a Brand Data Point
  /// Unlike a brand data point
  ///
  /// Parameters:
  /// * [id] - The ID of the Brand Data Point
  ...
  Future<Response<BrandDataPointResponseWrapper>> deleteBrandDataPointsIdLike({
    ...
    BrandDataPointResponseWrapper? _responseData;
    ...
    return Response<BrandDataPointResponseWrapper>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [id] - The id of the root brand data point
  /// * [replyId] - The id  of the replying brand data point
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  ///
  /// Parameters:
  /// * [id] - The uberall unique ID of the brand data point you want to reply to
  ...
  ///
  /// Parameters:
  /// * [id] - The id of the root brand data point to approve
  /// * [replyId] - The id of the replying brand data point to approve
