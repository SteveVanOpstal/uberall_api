...
class CategoriesApi {
  ...
  /// * [q] - Filter categories by a search query
  ...
  /// Parameters:
  /// * [id] - The Category id
  /// * [country] - The country to retrieve the attribute recommendations for
  /// * [keywords] - Keywords to look for which are associated with attributes
  /// * [locationId] - Location id to exclude already applied attributes on the provided location
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<AttributeRecommendationsWrapper>>
    ...
    AttributeRecommendationsWrapper? _responseData;
    ...
    return Response<AttributeRecommendationsWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [id] - The Category id
  /// * [country] - The country to retrieve the attributes for
  /// * [language] - The language to show the attributes in, this affects only the name of the results
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<AttributesResponseWrapper>> getCategoriesIdAttributes({
    ...
    AttributesResponseWrapper? _responseData;
    ...
    return Response<AttributesResponseWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [id] - Photo types for the location id
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<AvailablePhotoTypesResponseWrapper>>
    ...
    AvailablePhotoTypesResponseWrapper? _responseData;
    ...
    return Response<AvailablePhotoTypesResponseWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [id] - Category ID for retrieving services
  /// * [country] - Available structured services vary by country, so a country is needed to provide the available structured services from Google.
  /// * [language] - The language the structured services should be returned in.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<GoogleServicesResponseWrapper>>
    ...
    GoogleServicesResponseWrapper? _responseData;
    ...
    return Response<GoogleServicesResponseWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [id] - The Category id
  /// * [language] - The language to show the values in
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<MoreHoursWrapper>> getCategoriesIdMoreHoursTypes({
    ...
    MoreHoursWrapper? _responseData;
    ...
    return Response<MoreHoursWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
