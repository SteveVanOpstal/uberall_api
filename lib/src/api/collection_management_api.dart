...
class CollectionManagementApi {
  ...
  const CollectionManagementApi(this._dio, this._serializers);

  /// Delete a Collection
  /// Delete a specific Collection by id
  ///
  /// Parameters:
  /// * [id] - The uberall unique id of the Collection to delete
  /// * [contentCollection] - ContentCollection object to delete
  ...
  Future<Response<ContentListsWrapper>> getCollections({ 
    ...
    ContentListsWrapper? _responseData;
    ...
    return Response<ContentListsWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [id] - The uberall unique id of the Collection to retrieve
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<ContentCollection>> getCollectionsId({ 
    ...
    ContentCollection? _responseData;
    ...
    return Response<ContentCollection>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [id] - The uberall unique id of the Collection to update
  /// * [contentCollection] - ContentCollection object to update
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  ///
  /// Parameters:
  /// * [contentCollection] - ContentCollection object to create
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
