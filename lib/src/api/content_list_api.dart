...
class ContentListApi {
  ...
  const ContentListApi(this._dio, this._serializers);

  /// Delete a Content List
  /// Delete a content list
  ///
  /// Parameters:
  /// * [id] - The uberall unique id of the content list
  ...
  Future<Response<ContentListResponseWrapper>> getContentListsId({ 
    ...
    ContentListResponseWrapper? _responseData;
    ...
    return Response<ContentListResponseWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [id] - The uberall unique id of the content list
  /// * [contentListResponseWrapper] - A ContentList object
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  ///
  /// Parameters:
  /// * [contentList] - A ContentList object
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
