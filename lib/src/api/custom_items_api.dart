...
class CustomItemsApi {
  ...
  const CustomItemsApi(this._dio, this._serializers);
  ...
  Future<Response<UberallResponse>> deleteCustomItems({
  ...
  /// Returns a [Future] containing a [Response] with a [UberallResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UberallResponse>> deleteCustomItemsId({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<CustomItemSearchResponseWrapper>> getCustomItems({
    ...
    CustomItemSearchResponseWrapper? _responseData;
    ...
    return Response<CustomItemSearchResponseWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<CustomItemResponseWrapper>> getCustomItemsId({
    ...
    CustomItemResponseWrapper? _responseData;
    ...
    return Response<CustomItemResponseWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [id] - The uberall unique id for the custom item
  /// * [customItem] - CustomItem object to update
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  ///
  /// Parameters:
  /// * [customItem] - CustomItem object to create
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
