...
class DashboardExportsApi {
  ...
  const DashboardExportsApi(this._dio, this._serializers);

  /// Get a list of dashboard exports
  /// Get a list of dashboard exports.
  ///
  /// Parameters:
  /// * [locationIds] - List of location IDs to filter by
  ...
  Future<Response<DashboardExportDataListWrapper>> getDashboardExports({
    ...
    final _path = r'/dashboard-exports';
    ...
    DashboardExportDataListWrapper? _responseData;
    ...
    return Response<DashboardExportDataListWrapper>(
      data: _responseData,
  ...
  Future<Response<DashboardExportDataWrapper>> getDashboardExportsId({
    ...
    DashboardExportDataWrapper? _responseData;
    ...
    return Response<DashboardExportDataWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [start] - Start date of export, in yyyy-MM-dd format
  /// * [end] - End date of export, in yyyy-MM-dd format
  /// * [group] - Grouping of the historical data
  ...
  Future<Response<DashboardExportDataWrapper>> postDashboardExports({
    ...
    required String whitelabelIdentifier,
