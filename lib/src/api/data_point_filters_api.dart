...
class DataPointFiltersApi {
  ...
  const DataPointFiltersApi(this._dio, this._serializers);

  /// Delete a saved datapoint&#39;&#39;s filter
  /// Deletes a specific DataPointFilter
  ///
  /// Parameters:
  /// * [id] - ID of a DataPointFilter
  /// * [userId] - The user that is the owner of the filter. Required when request is done as API_ADMIN
  ...
  /// Parameters:
  /// * [id] - ID of a DataPointFilter
  /// * [userId] - ID of a user that should be unsubscribed from the filter
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<DataPointFilterResponseWrapper>> deleteDataPointsFiltersIdSubscription({ 
    ...
    DataPointFilterResponseWrapper? _responseData;
    ...
    return Response<DataPointFilterResponseWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [locationIds] - Applies a filter of locationIds
  /// * [userId] - Shows the filters of the user with this id
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<FiltersResponseWrapper>> getDataPointsFilters({ 
    ...
    final _path = r'/data-points/filters';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    FiltersResponseWrapper? _responseData;
    ...
    return Response<FiltersResponseWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<DataPointFiltersResponseWrapper>> getDataPointsFiltersList({ 
    ...
    final _path = r'/data-points/filters/list';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    DataPointFiltersResponseWrapper? _responseData;
    ...
    return Response<DataPointFiltersResponseWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [id] - ID of a DataPointFilter
  /// * [dataPointFilter] - A DataPointFilter object that needs to be updated
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  ///
  /// Parameters:
  /// * [dataPointFilter] - DataPointFilter object that needs to be created
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Parameters:
  /// * [id] - ID of a DataPointFilter
  /// * [userId] - ID of a user that should be subscribed to the filter
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
