...
class DigitalAssetManagementApi {
  ...
  const DigitalAssetManagementApi(this._dio, this._serializers);

  /// Edit an existing social template
  /// Edit an existing social template identified by its unique uberall ID
  ///
  /// Parameters:
  /// * [id] - The unique uberall ID for the Social Post Template you want to edit
  ...
  ///
  /// Parameters:
  /// * [postSocialTemplatesRequest] - A SocialPostTemplate object that should be created
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<SocialPostTemplateResponseWrapper>> postSocialTemplates({
    ...
    final _path = r'/social-templates';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
