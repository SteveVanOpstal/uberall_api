...
class FeedApi {
  ...
  Future<Response<FeedPost200Response>> feedIdChildrenGet({
    ...
    FeedPost200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(FeedPost200Response),
            ) as FeedPost200Response;
    ...
    return Response<FeedPost200Response>(
      data: _responseData,
  ...
  Future<Response<FeedDataItem>> feedIdGet({
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(FeedDataItem),
            ) as FeedDataItem;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [FeedPost200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FeedPost200Response>> feedPost({
    required FeedPostRequest feedPostRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(FeedPostRequest);
      _bodyData = _serializers.serialize(feedPostRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
