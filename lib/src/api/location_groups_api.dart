...
class LocationGroupsApi {
  ...
  const LocationGroupsApi(this._dio, this._serializers);

  /// Delete a single LocationGroup
  /// Can be used for deleting a single LocationGroup.
  ///
  /// Parameters:
  /// * [id] - ID of the LocationGroup that should be deleted.
  ...
  Future<Response<LocationGroupWrapper>> deleteLocationGroupsId({
    ...
    LocationGroupWrapper? _responseData;
    ...
    return Response<LocationGroupWrapper>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [fieldMask] - Used for bypassing pagination and reducing the response objects, following are supported ['id'', 'name']
  /// * [locationGroupIds] - Used for restricting the to be returned location groups within the given range of IDs.
  /// * [query] - Used for searching for a specific keyword within the location group names, only groups matching the given query via 'like' will be returned.
  /// * [max] - Used for pagination, specifies the amount of entries maximum returned per page (must be between 0-100).
  /// * [offset] - Used for pagination, specifies the starting point from which the returned subset should start.
  ...
  Future<Response<LocationGroupListResponseWrapper>> getLocationGroups({
    ...
    LocationGroupListResponseWrapper? _responseData;
    ...
    return Response<LocationGroupListResponseWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [id] - ID of the LocationGroup that should be returned.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  ///
  /// Parameters:
  /// * [id] - ID of the LocationGroup that should be updated.
  /// * [locationGroupParams] - LocationGroup to update
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  ///
  /// Parameters:
  /// * [locationGroupParams] - LocationGroup to create
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
