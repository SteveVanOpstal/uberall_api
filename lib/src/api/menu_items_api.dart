...
class MenuItemsApi {
  ...
  Future<Response<MenuItemSearchResponseWrapper>> getMenuItems({
    ...
    MenuItemSearchResponseWrapper? _responseData;
    ...
    return Response<MenuItemSearchResponseWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AcceptedExtraFieldsResponseWrapper>>
    ...
    final _path = r'/menu-items/accepted-extra-fields';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    AcceptedExtraFieldsResponseWrapper? _responseData;
    ...
    return Response<AcceptedExtraFieldsResponseWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<MenuItemResponseWrapper>> getMenuItemsId({
    ...
    MenuItemResponseWrapper? _responseData;
    ...
    return Response<MenuItemResponseWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [menuItem] - Menu Item object to update
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  ///
  /// Parameters:
  /// * [menuItem] - Menu Item object to create
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
