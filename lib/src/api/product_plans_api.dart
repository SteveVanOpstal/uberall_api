...
class ProductPlansApi {
  ...
  const ProductPlansApi(this._dio, this._serializers);

  /// Get All Product Plans
  /// Get all product plans available to the current API user
  ///
  /// Parameters:
  /// * [country] - Optional parameter to retrieve plans and supported directories for a specific country
  ...
  Future<Response<ProductPlanListResponseWrapper>> getProductPlans({ 
    ...
    ProductPlanListResponseWrapper? _responseData;
    ...
    return Response<ProductPlanListResponseWrapper>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [id] - The uberall unique id of the Product Plan
  /// * [productPlan] - A Product Plan object
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<ProductPlanResponseWrapper>> patchProductPlansId({ 
    ...
    ProductPlanResponseWrapper? _responseData;
    ...
    return Response<ProductPlanResponseWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
