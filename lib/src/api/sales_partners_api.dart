...
class SalesPartnersApi {
  ...
  const SalesPartnersApi(this._dio, this._serializers);
  ...
  ///
  /// Parameters:
  /// * [id] - Filter by specific uberall SalesPartner id
  /// * [query] - Filter by name or identifier
  /// * [status] - Filter by status
  /// * [sort] - SalesPartner property used for pagination. Default: 'id'
  ...
  Future<Response<SalesPartnerListResponseWrapper>> getSalesPartners({
    ...
    SalesPartnerListResponseWrapper? _responseData;
    ...
    return Response<SalesPartnerListResponseWrapper>(
      data: _responseData,
  ...
  Future<Response<SalesPartnerWrapper>> getSalesPartnersId({
    ...
    SalesPartnerWrapper? _responseData;
    ...
    return Response<SalesPartnerWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<SubscribableEventTypesWrapper>>
    ...
    final _path = r'/sales-partners/subscribable-event-types';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    SubscribableEventTypesWrapper? _responseData;
    ...
    return Response<SubscribableEventTypesWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [salesPartner] - SalesPartner data to create a new child SalesPartner
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Parameters:
  /// * [id] - ID of the SalesPartner
  /// * [salesPartner] - SalesPartner data to update
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
