...
class ServiceItemsApi {
  ...
  const ServiceItemsApi(this._dio, this._serializers);

  /// Delete a Service Item
  /// Delete a service item identified by identifier in the url param
  ///
  /// Parameters:
  /// * [id] - The uberall unique ID for the service item
  ...
  Future<Response<ServiceItemSearchWrapper>> getServiceItems({
    ...
    ServiceItemSearchWrapper? _responseData;
    ...
    return Response<ServiceItemSearchWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ServiceItemWrapper>> getServiceItemsId({
    ...
    ServiceItemWrapper? _responseData;
    ...
    return Response<ServiceItemWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [id] - The uberall unique ID for the service item you want to update
  /// * [serviceItem] - A ServiceItem object
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
