...
class SocialPostingTemplatesApi {
  ...
  const SocialPostingTemplatesApi(this._dio, this._serializers);

  /// Delete a Social Post Template
  /// Delete an existing Social Post Template identified by its unique uberall ID.
  ///
  /// Parameters:
  /// * [id] - Id of the Social Post Template that should be deleted
  /// * [userId] - Id of the user requesting to delete the social post template
  ...
  ///
  /// Parameters:
  /// * [userId] - Shows the templates of the user with this id
  ...
  Future<Response<SocialPostTemplatesResponseWrapper>> getSocialPostsTemplates({
    ...
    final _path = r'/social-posts/templates';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    SocialPostTemplatesResponseWrapper? _responseData;
    ...
    return Response<SocialPostTemplatesResponseWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [id] - Id of the Social Post Template
  /// * [userId] - Id of the user requesting the social post template
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<SocialPostTemplateResponseWrapper>>
    ...
    SocialPostTemplateResponseWrapper? _responseData;
    ...
    return Response<SocialPostTemplateResponseWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [id] - The unique uberall ID of the Social Post Template you want to edit
  /// * [socialPostTemplate] - A SocialPostTemplate object
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  ///
  /// Parameters:
  /// * [socialPostTemplate] - The Social Post Template to create
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
