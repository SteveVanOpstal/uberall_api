...
class TemplatesApi {
  ...
  ///
  /// Parameters:
  /// * [query] - Free text search that applies to title and message
  /// * [tags] - The tags values you want templates for
  /// * [minLastEdited] - The min date of the last update of the template
  /// * [maxLastEdited] - The max date of the last update of the template
  /// * [minTimesUsed] - The min usage count you want templates for
  /// * [maxTimesUsed] - The max usage count you want templates for
  /// * [createdBy] - The ids of authors you want templates for
  /// * [businesses] - The ids of businesses you want templates for
  /// * [locations] - The ids of locations you want templates for
  /// * [page] - Used for pagination. Page number we're interested in
  /// * [size] - Number of templates per page
  /// * [sort] - Name of the field we want to sort
  /// * [direction] - Use asc for ascending sort or desc for descending sort
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<ResponseTemplatesWrapper>> getTemplates({
    ...
    ResponseTemplatesWrapper? _responseData;
    ...
    return Response<ResponseTemplatesWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [getTemplatesAuthorsRequest] - The ids of businesses you want authors for
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<ResponseUsersWrapper>> getTemplatesAuthors({
    ...
    final _path = r'/templates/authors';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ResponseUsersWrapper? _responseData;
    ...
    return Response<ResponseUsersWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ResponseTemplateWrapper>> getTemplatesId({
    ...
    ResponseTemplateWrapper? _responseData;
    ...
    return Response<ResponseTemplateWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [getTemplatesAuthorsRequest] - The ids of businesses you want templates for
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<StringListResponseWrapper>> getTemplatesTags({
    ...
    StringListResponseWrapper? _responseData;
    ...
    return Response<StringListResponseWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [id] - The uberall unique id of the template
  /// * [createTemplateRequest] - Template to update
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  ///
  /// Parameters:
  /// * [createTemplateRequest] - Template to create
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
