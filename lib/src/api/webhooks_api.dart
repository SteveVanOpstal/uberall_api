...
class WebhooksApi {
  ...
  Future<Response<WebhookListWrapper>> getSalesPartnersWebhooks({
    ...
    final _path = r'/sales-partners/webhooks';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    WebhookListWrapper? _responseData;
    ...
    return Response<WebhookListWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<WebhookWrapper>> getSalesPartnersWebhooksId({
    ...
    return Response<WebhookWrapper>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
