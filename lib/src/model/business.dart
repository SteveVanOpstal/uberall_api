...
class BusinessTypeEnum extends EnumClass {
  ...
  static Serializer<BusinessTypeEnum> get serializer => _$businessTypeEnumSerializer;

  const BusinessTypeEnum._(String name): super(name);

  static BuiltSet<BusinessTypeEnum> get values => _$businessTypeEnumValues;
  static BusinessTypeEnum valueOf(String name) => _$businessTypeEnumValueOf(name);
}
...
class BusinessCountryEnum extends EnumClass {
  ...
  static Serializer<BusinessCountryEnum> get serializer => _$businessCountryEnumSerializer;

  const BusinessCountryEnum._(String name): super(name);

  static BuiltSet<BusinessCountryEnum> get values => _$businessCountryEnumValues;
  static BusinessCountryEnum valueOf(String name) => _$businessCountryEnumValueOf(name);
}
...
class BusinessStatusEnum extends EnumClass {
  ...
  static const BusinessStatusEnum NOT_CONFIRMED = _$businessStatusEnum_NOT_CONFIRMED;
  /// Business's status
  ...
  static Serializer<BusinessStatusEnum> get serializer => _$businessStatusEnumSerializer;
  ...
  static BusinessStatusEnum valueOf(String name) => _$businessStatusEnumValueOf(name);
}
