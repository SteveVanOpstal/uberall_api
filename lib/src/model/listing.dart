  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.mandatoryFields != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(ListingMandatoryFieldsEnum)]),
      );
    }
...
class ListingTypeEnum extends EnumClass {
  ...
  static const ListingTypeEnum LOKALEAUSKUNFT = _$listingTypeEnum_LOKALEAUSKUNFT;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum STADTBRANCHENBUCH = _$listingTypeEnum_STADTBRANCHENBUCH;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum UNTERNEHMENSAUSKUNFT = _$listingTypeEnum_UNTERNEHMENSAUSKUNFT;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum BUSINESSBRANCHENBUCH = _$listingTypeEnum_BUSINESSBRANCHENBUCH;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum THE_DAILY_RECORD = _$listingTypeEnum_THE_DAILY_RECORD;
  /// The directory where this listing appears.
  @BuiltValueEnumConst(wireName: r'THE_EVENING_STANDARD')
  static const ListingTypeEnum THE_EVENING_STANDARD = _$listingTypeEnum_THE_EVENING_STANDARD;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum LIVERPOOL_ECHO = _$listingTypeEnum_LIVERPOOL_ECHO;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum THE_INDEPENDENT = _$listingTypeEnum_THE_INDEPENDENT;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum OEFFNUNGSZEITENBUCH = _$listingTypeEnum_OEFFNUNGSZEITENBUCH;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum BUNDES_TELEFONBUCH = _$listingTypeEnum_BUNDES_TELEFONBUCH;
  /// The directory where this listing appears.
  @BuiltValueEnumConst(wireName: r'BRANCHENBUCH_DEUTSCHLAND')
  static const ListingTypeEnum BRANCHENBUCH_DEUTSCHLAND = _$listingTypeEnum_BRANCHENBUCH_DEUTSCHLAND;
  /// The directory where this listing appears.
  @BuiltValueEnumConst(wireName: r'MARKTPLATZ_MITTELSTAND')
  static const ListingTypeEnum MARKTPLATZ_MITTELSTAND = _$listingTypeEnum_MARKTPLATZ_MITTELSTAND;
  /// The directory where this listing appears.
  @BuiltValueEnumConst(wireName: r'BUSQUEDA_LOCAL')
  static const ListingTypeEnum BUSQUEDA_LOCAL = _$listingTypeEnum_BUSQUEDA_LOCAL;
  /// The directory where this listing appears.
  @BuiltValueEnumConst(wireName: r'RICERCARE_IMPRESE')
  static const ListingTypeEnum RICERCARE_IMPRESE = _$listingTypeEnum_RICERCARE_IMPRESE;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum SHOPPING_TIME_NETWORK = _$listingTypeEnum_SHOPPING_TIME_NETWORK;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum CHAMBER_OF_COMMERCE = _$listingTypeEnum_CHAMBER_OF_COMMERCE;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum MY_LOCAL_SERVICES = _$listingTypeEnum_MY_LOCAL_SERVICES;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum PALM_BEACH_POST = _$listingTypeEnum_PALM_BEACH_POST;
  /// The directory where this listing appears.
  @BuiltValueEnumConst(wireName: r'MUNDO_HISPANICO')
  static const ListingTypeEnum MUNDO_HISPANICO = _$listingTypeEnum_MUNDO_HISPANICO;
  /// The directory where this listing appears.
  @BuiltValueEnumConst(wireName: r'EL_TIEMPO_LATINO')
  static const ListingTypeEnum EL_TIEMPO_LATINO = _$listingTypeEnum_EL_TIEMPO_LATINO;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum BRANCHEN_INFO_MANUAL = _$listingTypeEnum_BRANCHEN_INFO_MANUAL;
  /// The directory where this listing appears.
  @BuiltValueEnumConst(wireName: r'GUTE_BANKEN_MANUAL')
  static const ListingTypeEnum GUTE_BANKEN_MANUAL = _$listingTypeEnum_GUTE_BANKEN_MANUAL;
  /// The directory where this listing appears.
  @BuiltValueEnumConst(wireName: r'D_11880_COM_MANUAL')
  static const ListingTypeEnum d11880COMMANUAL = _$listingTypeEnum_d11880COMMANUAL;
  /// The directory where this listing appears.
  @BuiltValueEnumConst(wireName: r'BANKOEFFNUNGSZEITEN_DE_MANUAL')
  static const ListingTypeEnum BANKOEFFNUNGSZEITEN_DE_MANUAL = _$listingTypeEnum_BANKOEFFNUNGSZEITEN_DE_MANUAL;
  /// The directory where this listing appears.
  @BuiltValueEnumConst(wireName: r'BANK_OEFFNUNGSZEITEN_DE_MANUAL')
  static const ListingTypeEnum BANK_OEFFNUNGSZEITEN_DE_MANUAL = _$listingTypeEnum_BANK_OEFFNUNGSZEITEN_DE_MANUAL;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum FINDE_OFFEN_MANUAL = _$listingTypeEnum_FINDE_OFFEN_MANUAL;
  /// The directory where this listing appears.
  @BuiltValueEnumConst(wireName: r'MEIN_PROSPEKT_MANUAL')
  static const ListingTypeEnum MEIN_PROSPEKT_MANUAL = _$listingTypeEnum_MEIN_PROSPEKT_MANUAL;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum SENSIS_WHITE_PAGES = _$listingTypeEnum_SENSIS_WHITE_PAGES;
  /// The directory where this listing appears.
  @BuiltValueEnumConst(wireName: r'SENSIS_TRUE_LOCAL')
  static const ListingTypeEnum SENSIS_TRUE_LOCAL = _$listingTypeEnum_SENSIS_TRUE_LOCAL;
  /// The directory where this listing appears.
  @BuiltValueEnumConst(wireName: r'SENSIS_YELLOW_PAGES')
  static const ListingTypeEnum SENSIS_YELLOW_PAGES = _$listingTypeEnum_SENSIS_YELLOW_PAGES;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum MEINUNGSMEISTER = _$listingTypeEnum_MEINUNGSMEISTER;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum YELLOW_PAGES_SINGAPORE = _$listingTypeEnum_YELLOW_PAGES_SINGAPORE;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum MICROSOFT_CORTANA = _$listingTypeEnum_MICROSOFT_CORTANA;
  /// The directory where this listing appears.
  @BuiltValueEnumConst(wireName: r'GOOGLE_ASSISTANT')
  static const ListingTypeEnum GOOGLE_ASSISTANT = _$listingTypeEnum_GOOGLE_ASSISTANT;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum WEBSITE_WIDGETS = _$listingTypeEnum_WEBSITE_WIDGETS;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum YELLOW_PAGES_CANADA = _$listingTypeEnum_YELLOW_PAGES_CANADA;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum UBERALL_SOCIAL_ADS = _$listingTypeEnum_UBERALL_SOCIAL_ADS;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum CONSUMER_AFFAIRS = _$listingTypeEnum_CONSUMER_AFFAIRS;
  /// The directory where this listing appears.
  ...
  static const ListingTypeEnum OPEN_TABLE_USA = _$listingTypeEnum_OPEN_TABLE_USA;
  /// The directory where this listing appears.
  ...
  static Serializer<ListingTypeEnum> get serializer => _$listingTypeEnumSerializer;
...
class ListingSyncStatusEnum extends EnumClass {
  ...
  static const ListingSyncStatusEnum NOT_IN_SYNC = _$listingSyncStatusEnum_NOT_IN_SYNC;
  /// The listing''s sync status.
  @BuiltValueEnumConst(wireName: r'NOT_FOUND')
  static const ListingSyncStatusEnum NOT_FOUND = _$listingSyncStatusEnum_NOT_FOUND;
  /// The listing''s sync status.
  @BuiltValueEnumConst(wireName: r'TECHNICAL_PROBLEMS')
  static const ListingSyncStatusEnum TECHNICAL_PROBLEMS = _$listingSyncStatusEnum_TECHNICAL_PROBLEMS;
  /// The listing''s sync status.
  @BuiltValueEnumConst(wireName: r'NOT_SUPPORTED')
  static const ListingSyncStatusEnum NOT_SUPPORTED = _$listingSyncStatusEnum_NOT_SUPPORTED;
  /// The listing''s sync status.
  @BuiltValueEnumConst(wireName: r'NO_ONLINE_LISTING')
  static const ListingSyncStatusEnum NO_ONLINE_LISTING = _$listingSyncStatusEnum_NO_ONLINE_LISTING;
  /// The listing''s sync status.
  @BuiltValueEnumConst(wireName: r'LINK_ONLY')
  static const ListingSyncStatusEnum LINK_ONLY = _$listingSyncStatusEnum_LINK_ONLY;

  static Serializer<ListingSyncStatusEnum> get serializer => _$listingSyncStatusEnumSerializer;

  const ListingSyncStatusEnum._(String name): super(name);

  static BuiltSet<ListingSyncStatusEnum> get values => _$listingSyncStatusEnumValues;
  static ListingSyncStatusEnum valueOf(String name) => _$listingSyncStatusEnumValueOf(name);
}
...
class ListingClaimStatusEnum extends EnumClass {
  ...
  static const ListingClaimStatusEnum CLAIMABLE = _$listingClaimStatusEnum_CLAIMABLE;
  /// Claim status of the listing.
  @BuiltValueEnumConst(wireName: r'NOT_CLAIMABLE')
  static const ListingClaimStatusEnum NOT_CLAIMABLE = _$listingClaimStatusEnum_NOT_CLAIMABLE;
  /// Claim status of the listing.
  @BuiltValueEnumConst(wireName: r'CLAIMED_BY_US')
  static const ListingClaimStatusEnum CLAIMED_BY_US = _$listingClaimStatusEnum_CLAIMED_BY_US;
  /// Claim status of the listing.
  @BuiltValueEnumConst(wireName: r'CLAIMED_BY_OTHERS')
  static const ListingClaimStatusEnum CLAIMED_BY_OTHERS = _$listingClaimStatusEnum_CLAIMED_BY_OTHERS;
  /// Claim status of the listing.
  @BuiltValueEnumConst(wireName: r'CLAIMED_BY_ANOTHER_US')
  static const ListingClaimStatusEnum CLAIMED_BY_ANOTHER_US = _$listingClaimStatusEnum_CLAIMED_BY_ANOTHER_US;
  /// Claim status of the listing.
  @BuiltValueEnumConst(wireName: r'CLAIMING_IN_PROGRESS')
  static const ListingClaimStatusEnum CLAIMING_IN_PROGRESS = _$listingClaimStatusEnum_CLAIMING_IN_PROGRESS;
  /// Claim status of the listing.
  @BuiltValueEnumConst(wireName: r'UNKNOWN')
  static const ListingClaimStatusEnum UNKNOWN = _$listingClaimStatusEnum_UNKNOWN;

  static Serializer<ListingClaimStatusEnum> get serializer => _$listingClaimStatusEnumSerializer;

  const ListingClaimStatusEnum._(String name): super(name);

  static BuiltSet<ListingClaimStatusEnum> get values => _$listingClaimStatusEnumValues;
  static ListingClaimStatusEnum valueOf(String name) => _$listingClaimStatusEnumValueOf(name);
}
...
class ListingConnectStatusEnum extends EnumClass {
  ...
  static const ListingConnectStatusEnum CONNECTED = _$listingConnectStatusEnum_CONNECTED;
  /// Connect status of the listing.
  @BuiltValueEnumConst(wireName: r'NOT_CONNECTED')
  static const ListingConnectStatusEnum NOT_CONNECTED = _$listingConnectStatusEnum_NOT_CONNECTED;
  /// Connect status of the listing.
  @BuiltValueEnumConst(wireName: r'NOT_NEEDED')
  static const ListingConnectStatusEnum NOT_NEEDED = _$listingConnectStatusEnum_NOT_NEEDED;

  static Serializer<ListingConnectStatusEnum> get serializer => _$listingConnectStatusEnumSerializer;

  const ListingConnectStatusEnum._(String name): super(name);

  static BuiltSet<ListingConnectStatusEnum> get values => _$listingConnectStatusEnumValues;
  static ListingConnectStatusEnum valueOf(String name) => _$listingConnectStatusEnumValueOf(name);
}

class ListingMandatoryFieldsEnum extends EnumClass {

  @BuiltValueEnumConst(wireName: r'NAME')
  static const ListingMandatoryFieldsEnum NAME = _$listingMandatoryFieldsEnum_NAME;
  @BuiltValueEnumConst(wireName: r'NAME_DESCRIPTOR')
  static const ListingMandatoryFieldsEnum NAME_DESCRIPTOR = _$listingMandatoryFieldsEnum_NAME_DESCRIPTOR;
  @BuiltValueEnumConst(wireName: r'STREET_NO')
  static const ListingMandatoryFieldsEnum STREET_NO = _$listingMandatoryFieldsEnum_STREET_NO;
  @BuiltValueEnumConst(wireName: r'STREET')
  static const ListingMandatoryFieldsEnum STREET = _$listingMandatoryFieldsEnum_STREET;
  @BuiltValueEnumConst(wireName: r'STREET_TYPE')
  static const ListingMandatoryFieldsEnum STREET_TYPE = _$listingMandatoryFieldsEnum_STREET_TYPE;
  @BuiltValueEnumConst(wireName: r'ADDRESS_EXTRA')
  static const ListingMandatoryFieldsEnum ADDRESS_EXTRA = _$listingMandatoryFieldsEnum_ADDRESS_EXTRA;
  @BuiltValueEnumConst(wireName: r'PROVINCE')
  static const ListingMandatoryFieldsEnum PROVINCE = _$listingMandatoryFieldsEnum_PROVINCE;
  @BuiltValueEnumConst(wireName: r'ZIP')
  static const ListingMandatoryFieldsEnum ZIP = _$listingMandatoryFieldsEnum_ZIP;
  @BuiltValueEnumConst(wireName: r'CITY')
  static const ListingMandatoryFieldsEnum CITY = _$listingMandatoryFieldsEnum_CITY;
  @BuiltValueEnumConst(wireName: r'COUNTRY')
  static const ListingMandatoryFieldsEnum COUNTRY = _$listingMandatoryFieldsEnum_COUNTRY;
  @BuiltValueEnumConst(wireName: r'LATITUDE')
  static const ListingMandatoryFieldsEnum LATITUDE = _$listingMandatoryFieldsEnum_LATITUDE;
  @BuiltValueEnumConst(wireName: r'LONGITUDE')
  static const ListingMandatoryFieldsEnum LONGITUDE = _$listingMandatoryFieldsEnum_LONGITUDE;
  @BuiltValueEnumConst(wireName: r'ADDRESS_DISPLAY')
  static const ListingMandatoryFieldsEnum ADDRESS_DISPLAY = _$listingMandatoryFieldsEnum_ADDRESS_DISPLAY;
  @BuiltValueEnumConst(wireName: r'SERVICE_AREAS')
  static const ListingMandatoryFieldsEnum SERVICE_AREAS = _$listingMandatoryFieldsEnum_SERVICE_AREAS;
  @BuiltValueEnumConst(wireName: r'CATEGORIES')
  static const ListingMandatoryFieldsEnum CATEGORIES = _$listingMandatoryFieldsEnum_CATEGORIES;
  @BuiltValueEnumConst(wireName: r'OPENING_DATE')
  static const ListingMandatoryFieldsEnum OPENING_DATE = _$listingMandatoryFieldsEnum_OPENING_DATE;
  @BuiltValueEnumConst(wireName: r'PHONE')
  static const ListingMandatoryFieldsEnum PHONE = _$listingMandatoryFieldsEnum_PHONE;
  @BuiltValueEnumConst(wireName: r'CELLPHONE')
  static const ListingMandatoryFieldsEnum CELLPHONE = _$listingMandatoryFieldsEnum_CELLPHONE;
  @BuiltValueEnumConst(wireName: r'FAX')
  static const ListingMandatoryFieldsEnum FAX = _$listingMandatoryFieldsEnum_FAX;
  @BuiltValueEnumConst(wireName: r'WEBSITE')
  static const ListingMandatoryFieldsEnum WEBSITE = _$listingMandatoryFieldsEnum_WEBSITE;
  @BuiltValueEnumConst(wireName: r'WEBSITE_EXTRA')
  static const ListingMandatoryFieldsEnum WEBSITE_EXTRA = _$listingMandatoryFieldsEnum_WEBSITE_EXTRA;
  @BuiltValueEnumConst(wireName: r'EMAIL')
  static const ListingMandatoryFieldsEnum EMAIL = _$listingMandatoryFieldsEnum_EMAIL;
  @BuiltValueEnumConst(wireName: r'OPENINGHOURS')
  static const ListingMandatoryFieldsEnum OPENINGHOURS = _$listingMandatoryFieldsEnum_OPENINGHOURS;
  @BuiltValueEnumConst(wireName: r'OPENINGHOURS_NOTES')
  static const ListingMandatoryFieldsEnum OPENINGHOURS_NOTES = _$listingMandatoryFieldsEnum_OPENINGHOURS_NOTES;
  @BuiltValueEnumConst(wireName: r'SPECIAL_OPENINGHOURS')
  static const ListingMandatoryFieldsEnum SPECIAL_OPENINGHOURS = _$listingMandatoryFieldsEnum_SPECIAL_OPENINGHOURS;
  @BuiltValueEnumConst(wireName: r'MORE_HOURS')
  static const ListingMandatoryFieldsEnum MORE_HOURS = _$listingMandatoryFieldsEnum_MORE_HOURS;
  @BuiltValueEnumConst(wireName: r'KEYWORDS')
  static const ListingMandatoryFieldsEnum KEYWORDS = _$listingMandatoryFieldsEnum_KEYWORDS;
  @BuiltValueEnumConst(wireName: r'DESCRIPTION_SHORT')
  static const ListingMandatoryFieldsEnum DESCRIPTION_SHORT = _$listingMandatoryFieldsEnum_DESCRIPTION_SHORT;
  @BuiltValueEnumConst(wireName: r'DESCRIPTION_LONG')
  static const ListingMandatoryFieldsEnum DESCRIPTION_LONG = _$listingMandatoryFieldsEnum_DESCRIPTION_LONG;
  @BuiltValueEnumConst(wireName: r'IMPRINT')
  static const ListingMandatoryFieldsEnum IMPRINT = _$listingMandatoryFieldsEnum_IMPRINT;
  @BuiltValueEnumConst(wireName: r'LEGAL_IDENT')
  static const ListingMandatoryFieldsEnum LEGAL_IDENT = _$listingMandatoryFieldsEnum_LEGAL_IDENT;
  @BuiltValueEnumConst(wireName: r'TAX_NUMBER')
  static const ListingMandatoryFieldsEnum TAX_NUMBER = _$listingMandatoryFieldsEnum_TAX_NUMBER;
  @BuiltValueEnumConst(wireName: r'ATTRIBUTION')
  static const ListingMandatoryFieldsEnum ATTRIBUTION = _$listingMandatoryFieldsEnum_ATTRIBUTION;
  @BuiltValueEnumConst(wireName: r'IS_PUBLISHED')
  static const ListingMandatoryFieldsEnum IS_PUBLISHED = _$listingMandatoryFieldsEnum_IS_PUBLISHED;
  @BuiltValueEnumConst(wireName: r'SOCIAL_PROFILES')
  static const ListingMandatoryFieldsEnum SOCIAL_PROFILES = _$listingMandatoryFieldsEnum_SOCIAL_PROFILES;
  @BuiltValueEnumConst(wireName: r'ATTRIBUTES')
  static const ListingMandatoryFieldsEnum ATTRIBUTES = _$listingMandatoryFieldsEnum_ATTRIBUTES;
  @BuiltValueEnumConst(wireName: r'PAYMENT_OPTIONS')
  static const ListingMandatoryFieldsEnum PAYMENT_OPTIONS = _$listingMandatoryFieldsEnum_PAYMENT_OPTIONS;
  @BuiltValueEnumConst(wireName: r'BRANDS')
  static const ListingMandatoryFieldsEnum BRANDS = _$listingMandatoryFieldsEnum_BRANDS;
  @BuiltValueEnumConst(wireName: r'LANGUAGES')
  static const ListingMandatoryFieldsEnum LANGUAGES = _$listingMandatoryFieldsEnum_LANGUAGES;
  @BuiltValueEnumConst(wireName: r'SERVICES')
  static const ListingMandatoryFieldsEnum SERVICES = _$listingMandatoryFieldsEnum_SERVICES;
  @BuiltValueEnumConst(wireName: r'CONTENT_LISTS')
  static const ListingMandatoryFieldsEnum CONTENT_LISTS = _$listingMandatoryFieldsEnum_CONTENT_LISTS;
  @BuiltValueEnumConst(wireName: r'PHOTOS')
  static const ListingMandatoryFieldsEnum PHOTOS = _$listingMandatoryFieldsEnum_PHOTOS;
  @BuiltValueEnumConst(wireName: r'VIDEOS')
  static const ListingMandatoryFieldsEnum VIDEOS = _$listingMandatoryFieldsEnum_VIDEOS;
  @BuiltValueEnumConst(wireName: r'SOCIAL_POST')
  static const ListingMandatoryFieldsEnum SOCIAL_POST = _$listingMandatoryFieldsEnum_SOCIAL_POST;
  @BuiltValueEnumConst(wireName: r'DOCTOR_CATEGORIES')
  static const ListingMandatoryFieldsEnum DOCTOR_CATEGORIES = _$listingMandatoryFieldsEnum_DOCTOR_CATEGORIES;
  @BuiltValueEnumConst(wireName: r'NPI')
  static const ListingMandatoryFieldsEnum NPI = _$listingMandatoryFieldsEnum_NPI;
  @BuiltValueEnumConst(wireName: r'EV_DATA')
  static const ListingMandatoryFieldsEnum EV_DATA = _$listingMandatoryFieldsEnum_EV_DATA;
  @BuiltValueEnumConst(wireName: r'TRANSACTION_LINKS')
  static const ListingMandatoryFieldsEnum TRANSACTION_LINKS = _$listingMandatoryFieldsEnum_TRANSACTION_LINKS;
  @BuiltValueEnumConst(wireName: r'SUBLOCALITY')
  static const ListingMandatoryFieldsEnum SUBLOCALITY = _$listingMandatoryFieldsEnum_SUBLOCALITY;
  @BuiltValueEnumConst(wireName: r'CUSTOM_FIELDS')
  static const ListingMandatoryFieldsEnum CUSTOM_FIELDS = _$listingMandatoryFieldsEnum_CUSTOM_FIELDS;

  static Serializer<ListingMandatoryFieldsEnum> get serializer => _$listingMandatoryFieldsEnumSerializer;

  const ListingMandatoryFieldsEnum._(String name): super(name);

  static BuiltSet<ListingMandatoryFieldsEnum> get values => _$listingMandatoryFieldsEnumValues;
  static ListingMandatoryFieldsEnum valueOf(String name) => _$listingMandatoryFieldsEnumValueOf(name);
}
...
class ListingStatusEnum extends EnumClass {
  ...
  static Serializer<ListingStatusEnum> get serializer => _$listingStatusEnumSerializer;

  const ListingStatusEnum._(String name): super(name);

  static BuiltSet<ListingStatusEnum> get values => _$listingStatusEnumValues;
  static ListingStatusEnum valueOf(String name) => _$listingStatusEnumValueOf(name);
}
