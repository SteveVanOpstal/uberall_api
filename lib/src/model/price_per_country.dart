...
/// * [productPlanId] 
@BuiltValue()
abstract class PricePerCountry implements Built<PricePerCountry, PricePerCountryBuilder> {
  /// Country
  ...
  factory PricePerCountry([void updates(PricePerCountryBuilder b)]) = _$PricePerCountry;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PricePerCountryBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PricePerCountry> get serializer => _$PricePerCountrySerializer();
}

class _$PricePerCountrySerializer implements PrimitiveSerializer<PricePerCountry> {
  @override
...
class PricePerCountryCountryEnum extends EnumClass {
  ...
  static Serializer<PricePerCountryCountryEnum> get serializer => _$pricePerCountryCountryEnumSerializer;

  const PricePerCountryCountryEnum._(String name): super(name);

  static BuiltSet<PricePerCountryCountryEnum> get values => _$pricePerCountryCountryEnumValues;
  static PricePerCountryCountryEnum valueOf(String name) => _$pricePerCountryCountryEnumValueOf(name);
}
