...
class SearchDataCountryEnum extends EnumClass {
  ...
  static Serializer<SearchDataCountryEnum> get serializer => _$searchDataCountryEnumSerializer;

  const SearchDataCountryEnum._(String name): super(name);

  static BuiltSet<SearchDataCountryEnum> get values => _$searchDataCountryEnumValues;
  static SearchDataCountryEnum valueOf(String name) => _$searchDataCountryEnumValueOf(name);
}
