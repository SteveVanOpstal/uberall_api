...
class _$UserSerializer implements PrimitiveSerializer<User> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.whitelabelInformationId != null) {
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'salesPartnerId':
          ...
          break;
        case r'whitelabelInformationId':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(JsonObject),
          ) as JsonObject;
        ...
        case r'directoryUsers':
          ...
          result.directoryUsers = valueDes;
          break;
...
class UserSalutationEnum extends EnumClass {
  ...
  static Serializer<UserSalutationEnum> get serializer => _$userSalutationEnumSerializer;
  ...
  static UserSalutationEnum valueOf(String name) => _$userSalutationEnumValueOf(name);
}
...
class UserRoleEnum extends EnumClass {
  ...
  static const UserRoleEnum BUSINESS_MANAGER_INBOX = _$userRoleEnum_BUSINESS_MANAGER_INBOX;
...
class UserFeaturesEnum extends EnumClass {
  ...
  static const UserFeaturesEnum NEW_PHOTO_TYPES = _$userFeaturesEnum_NEW_PHOTO_TYPES;
  /// A list of features this user can work with
  ...
  static const UserFeaturesEnum ADVANCED_ANALYTICS = _$userFeaturesEnum_ADVANCED_ANALYTICS;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'AI_KNOWLEDGEBASE')
  static const UserFeaturesEnum AI_KNOWLEDGEBASE = _$userFeaturesEnum_AI_KNOWLEDGEBASE;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'AI_LOCALISATION')
  static const UserFeaturesEnum AI_LOCALISATION = _$userFeaturesEnum_AI_LOCALISATION;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'AI_SUGGESTED_REPLIES')
  static const UserFeaturesEnum AI_SUGGESTED_REPLIES = _$userFeaturesEnum_AI_SUGGESTED_REPLIES;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'APPLE_POSTING')
  static const UserFeaturesEnum APPLE_POSTING = _$userFeaturesEnum_APPLE_POSTING;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'APPLE_POSTING_WRITE')
  static const UserFeaturesEnum APPLE_POSTING_WRITE = _$userFeaturesEnum_APPLE_POSTING_WRITE;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'AUTO_RESPONSE')
  static const UserFeaturesEnum AUTO_RESPONSE = _$userFeaturesEnum_AUTO_RESPONSE;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'AUTO_RESPONSE_WRITE')
  static const UserFeaturesEnum AUTO_RESPONSE_WRITE = _$userFeaturesEnum_AUTO_RESPONSE_WRITE;
  /// A list of features this user can work with
  ...
  static const UserFeaturesEnum INSTAGRAM_POSTING = _$userFeaturesEnum_INSTAGRAM_POSTING;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'INSTAGRAM_POSTING_WRITE')
  static const UserFeaturesEnum INSTAGRAM_POSTING_WRITE = _$userFeaturesEnum_INSTAGRAM_POSTING_WRITE;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'BUSINESS_LEVEL_CONNECT')
  static const UserFeaturesEnum BUSINESS_LEVEL_CONNECT = _$userFeaturesEnum_BUSINESS_LEVEL_CONNECT;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'CALL_TRACKING_NUMBERS')
  static const UserFeaturesEnum CALL_TRACKING_NUMBERS = _$userFeaturesEnum_CALL_TRACKING_NUMBERS;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'CAN_PAY_INVOICE')
  static const UserFeaturesEnum CAN_PAY_INVOICE = _$userFeaturesEnum_CAN_PAY_INVOICE;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'CAN_SEE_HELP_SECTION')
  static const UserFeaturesEnum CAN_SEE_HELP_SECTION = _$userFeaturesEnum_CAN_SEE_HELP_SECTION;
  /// A list of features this user can work with
  ...
  static const UserFeaturesEnum CHATBOT_WRITE = _$userFeaturesEnum_CHATBOT_WRITE;
  /// A list of features this user can work with
  ...
  static const UserFeaturesEnum CONTENT_COLLECTION = _$userFeaturesEnum_CONTENT_COLLECTION;
  /// A list of features this user can work with
  ...
  static const UserFeaturesEnum ENTERPRISE_ONBOARDING = _$userFeaturesEnum_ENTERPRISE_ONBOARDING;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'FACEBOOK_UNOWNED_PAGE_CREATE')
  static const UserFeaturesEnum FACEBOOK_UNOWNED_PAGE_CREATE = _$userFeaturesEnum_FACEBOOK_UNOWNED_PAGE_CREATE;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'FIRST_PARTY_REVIEW_APPROVAL')
  static const UserFeaturesEnum FIRST_PARTY_REVIEW_APPROVAL = _$userFeaturesEnum_FIRST_PARTY_REVIEW_APPROVAL;
  /// A list of features this user can work with
  ...
  static const UserFeaturesEnum INBOX_APPROVAL = _$userFeaturesEnum_INBOX_APPROVAL;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'INBOX_PREVIEW')
  static const UserFeaturesEnum INBOX_PREVIEW = _$userFeaturesEnum_INBOX_PREVIEW;
  /// A list of features this user can work with
  ...
  static const UserFeaturesEnum INBOX_TWITTER = _$userFeaturesEnum_INBOX_TWITTER;
  /// A list of features this user can work with
  ...
  static const UserFeaturesEnum iNBOX20BETAREAD = _$userFeaturesEnum_iNBOX20BETAREAD;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'INBOX_2_0_BETA_WRITE')
  static const UserFeaturesEnum iNBOX20BETAWRITE = _$userFeaturesEnum_iNBOX20BETAWRITE;
  /// A list of features this user can work with
  ...
  static const UserFeaturesEnum LOCAL_SEO_REPORT = _$userFeaturesEnum_LOCAL_SEO_REPORT;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'LOCATION_APPROVAL_REQUESTS')
  static const UserFeaturesEnum LOCATION_APPROVAL_REQUESTS = _$userFeaturesEnum_LOCATION_APPROVAL_REQUESTS;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'LOCATION_GROUP')
  static const UserFeaturesEnum LOCATION_GROUP = _$userFeaturesEnum_LOCATION_GROUP;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'LOCATION_STATUS_CHANGE')
  static const UserFeaturesEnum LOCATION_STATUS_CHANGE = _$userFeaturesEnum_LOCATION_STATUS_CHANGE;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'LOCATION_TRANSLATION')
  static const UserFeaturesEnum LOCATION_TRANSLATION = _$userFeaturesEnum_LOCATION_TRANSLATION;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'LOCATION_READ')
  static const UserFeaturesEnum LOCATION_READ = _$userFeaturesEnum_LOCATION_READ;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'LOCATION_WRITE')
  static const UserFeaturesEnum LOCATION_WRITE = _$userFeaturesEnum_LOCATION_WRITE;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'LOCAL_INVENTORY')
  static const UserFeaturesEnum LOCAL_INVENTORY = _$userFeaturesEnum_LOCAL_INVENTORY;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'MANUAL_LISTINGS')
  static const UserFeaturesEnum MANUAL_LISTINGS = _$userFeaturesEnum_MANUAL_LISTINGS;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'NEAR_ME_CHECK')
  static const UserFeaturesEnum NEAR_ME_CHECK = _$userFeaturesEnum_NEAR_ME_CHECK;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'PHONE_OPTIONAL')
  static const UserFeaturesEnum PHONE_OPTIONAL = _$userFeaturesEnum_PHONE_OPTIONAL;
  /// A list of features this user can work with
  ...
  static const UserFeaturesEnum POSTING_APPROVAL = _$userFeaturesEnum_POSTING_APPROVAL;
  /// A list of features this user can work with
  ...
  static const UserFeaturesEnum POSTING_TONE_ADJUST = _$userFeaturesEnum_POSTING_TONE_ADJUST;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'POSTING_WRITE')
  static const UserFeaturesEnum POSTING_WRITE = _$userFeaturesEnum_POSTING_WRITE;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'POSTING_PREVIEW')
  static const UserFeaturesEnum POSTING_PREVIEW = _$userFeaturesEnum_POSTING_PREVIEW;
  /// A list of features this user can work with
  ...
  static const UserFeaturesEnum QR_CODE_GENERATION = _$userFeaturesEnum_QR_CODE_GENERATION;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'RESPONSE_LIBRARY')
  static const UserFeaturesEnum RESPONSE_LIBRARY = _$userFeaturesEnum_RESPONSE_LIBRARY;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'RESPONSE_LIBRARY_READ')
  static const UserFeaturesEnum RESPONSE_LIBRARY_READ = _$userFeaturesEnum_RESPONSE_LIBRARY_READ;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'RESPONSE_LIBRARY_WRITE')
  static const UserFeaturesEnum RESPONSE_LIBRARY_WRITE = _$userFeaturesEnum_RESPONSE_LIBRARY_WRITE;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'REVIEW_GENERATION_EMAIL')
  static const UserFeaturesEnum REVIEW_GENERATION_EMAIL = _$userFeaturesEnum_REVIEW_GENERATION_EMAIL;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'REVIEW_GENERATION_SMS')
  static const UserFeaturesEnum REVIEW_GENERATION_SMS = _$userFeaturesEnum_REVIEW_GENERATION_SMS;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'REVIEW_GENERATION_CREATE')
  static const UserFeaturesEnum REVIEW_GENERATION_CREATE = _$userFeaturesEnum_REVIEW_GENERATION_CREATE;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'REVIEW_GENERATION_SEND')
  static const UserFeaturesEnum REVIEW_GENERATION_SEND = _$userFeaturesEnum_REVIEW_GENERATION_SEND;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'LOCATION_APPROVAL')
  static const UserFeaturesEnum LOCATION_APPROVAL = _$userFeaturesEnum_LOCATION_APPROVAL;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'LOCATION_SCHEDULED_UPDATES')
  static const UserFeaturesEnum LOCATION_SCHEDULED_UPDATES = _$userFeaturesEnum_LOCATION_SCHEDULED_UPDATES;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'SINGLE_SIGN_ON')
  static const UserFeaturesEnum SINGLE_SIGN_ON = _$userFeaturesEnum_SINGLE_SIGN_ON;
  /// A list of features this user can work with
  ...
  static const UserFeaturesEnum STOREFINDER_TRIAL_MODE = _$userFeaturesEnum_STOREFINDER_TRIAL_MODE;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'LOCATOR_PAGES_BUILDER')
  static const UserFeaturesEnum LOCATOR_PAGES_BUILDER = _$userFeaturesEnum_LOCATOR_PAGES_BUILDER;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'STOREFINDER_ANALYTICS')
  static const UserFeaturesEnum STOREFINDER_ANALYTICS = _$userFeaturesEnum_STOREFINDER_ANALYTICS;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'STOREFINDER_GOOGLE')
  static const UserFeaturesEnum STOREFINDER_GOOGLE = _$userFeaturesEnum_STOREFINDER_GOOGLE;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'STOREFINDER_MAPBOX')
  static const UserFeaturesEnum STOREFINDER_MAPBOX = _$userFeaturesEnum_STOREFINDER_MAPBOX;
  /// A list of features this user can work with
  ...
  static const UserFeaturesEnum TRANSACTION_LINKS = _$userFeaturesEnum_TRANSACTION_LINKS;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'TWITTER_INBOX_READ')
  static const UserFeaturesEnum TWITTER_INBOX_READ = _$userFeaturesEnum_TWITTER_INBOX_READ;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'TWITTER_INBOX_WRITE')
  static const UserFeaturesEnum TWITTER_INBOX_WRITE = _$userFeaturesEnum_TWITTER_INBOX_WRITE;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'TWITTER_POSTING')
  static const UserFeaturesEnum TWITTER_POSTING = _$userFeaturesEnum_TWITTER_POSTING;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'TWITTER_POSTING_WRITE')
  static const UserFeaturesEnum TWITTER_POSTING_WRITE = _$userFeaturesEnum_TWITTER_POSTING_WRITE;
  /// A list of features this user can work with
  ...
  static const UserFeaturesEnum USER_OTHERS_EDIT = _$userFeaturesEnum_USER_OTHERS_EDIT;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'USER_SELF_EDIT')
  static const UserFeaturesEnum USER_SELF_EDIT = _$userFeaturesEnum_USER_SELF_EDIT;
  /// A list of features this user can work with
  ...
  static const UserFeaturesEnum WEBSITE_WIDGETS = _$userFeaturesEnum_WEBSITE_WIDGETS;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'EXPANDED_REVIEWS_RESTAURANT')
  static const UserFeaturesEnum EXPANDED_REVIEWS_RESTAURANT = _$userFeaturesEnum_EXPANDED_REVIEWS_RESTAURANT;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'EXPANDED_REVIEWS_FINANCE')
  static const UserFeaturesEnum EXPANDED_REVIEWS_FINANCE = _$userFeaturesEnum_EXPANDED_REVIEWS_FINANCE;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'WHATS_APP_MESSAGES')
  static const UserFeaturesEnum WHATS_APP_MESSAGES = _$userFeaturesEnum_WHATS_APP_MESSAGES;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'ACCESS_REQUEST_INVITATIONS')
  static const UserFeaturesEnum ACCESS_REQUEST_INVITATIONS = _$userFeaturesEnum_ACCESS_REQUEST_INVITATIONS;
  /// A list of features this user can work with
  @BuiltValueEnumConst(wireName: r'AI_BULK_REPLIES')
  static const UserFeaturesEnum AI_BULK_REPLIES = _$userFeaturesEnum_AI_BULK_REPLIES;

  static Serializer<UserFeaturesEnum> get serializer => _$userFeaturesEnumSerializer;

  const UserFeaturesEnum._(String name): super(name);

  static BuiltSet<UserFeaturesEnum> get values => _$userFeaturesEnumValues;
  static UserFeaturesEnum valueOf(String name) => _$userFeaturesEnumValueOf(name);
}
