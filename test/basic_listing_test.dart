...
void main() {
  // final instance = BasicListing();

  group('test BasicListing', () {
    ...
    // List<OpeningHours> openingHours (default value: const [])
    ...
    // List<Object> moreHours (default value: const [])
    ...
    // List<SpecialOpeningHours> specialOpeningHours (default value: const [])
    ...
    // List<Object> categories (default value: const [])
    ...
    // List<Object> attributes (default value: const [])
    ...
    // List<Object> paymentOptions (default value: const [])
    ...
    // List<Object> doctorCategories (default value: const [])
    ...
    // Map<String, String> customFields (default value: const {})
    ...
    // The video of the social post (can only be one)
    // List<String> services (default value: const [])
    ...
    // List<SocialProfile> socialProfiles (default value: const [])
    test('to test the property `socialProfiles`', () async {
      // TODO
    });

    // Content lists shown on the listing
    // List<ContentList> contentLists (default value: const [])
