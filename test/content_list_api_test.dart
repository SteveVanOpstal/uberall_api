...
/// tests for ContentListApi
void main() {
  // final instance = ContentListApi();

  group('tests for ContentListApi', () {
    // Delete a Content List
    //
    // Delete a content list
    //
    //Future<Response> deleteContentListsId(String id) async
    test('test deleteContentListsId', () async {
      // TODO
    });
    ...
    test('test getContentLists', () async {
      // TODO
    });
    ...
    test('test getContentListsId', () async {
      // TODO
    });
    ...
    test('test patchContentListsId', () async {
      // TODO
    });
    ...
    test('test postContentLists', () async {
      // TODO
    });
