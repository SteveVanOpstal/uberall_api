...
void main() {
  // final instance = CustomerFeedbackByPeriod();

  group('test CustomerFeedbackByPeriod', () {
    // The number of reviews and photos unread by period
    // List<Map<String, Object>> interactionCountByPeriod (default value: const [])
    ...
    // List<TimeSeriesSegment> averageRatingByPeriod (default value: const [])
