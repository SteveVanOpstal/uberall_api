...
void main() {
  // final instance = CustomerFeedback();

  group('test CustomerFeedback', () {
    // Average count by rating
    // List<Map<String, Object>> countByRating (default value: const [])
    ...
    // List<DataPoint> unreadInteractions (default value: const [])
