...
void main() {
  // final instance = DataPointFilter();

  group('test DataPointFilter', () {
    // The filter name
    // String name
    ...
    // Set<String> dataPointTypes (default value: const {})
    ...
    // Set<int> ratings (default value: const {})
    ...
    // Set<int> businessIds (default value: const {})
    ...
    // List<int> subscriberIds (default value: const [])
