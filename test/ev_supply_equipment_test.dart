...
void main() {
  // final instance = EvSupplyEquipment();

  group('test EvSupplyEquipment', () {
    ...
    // Set<EvConnector> connectors (default value: const {})
    ...
    // Set<String> parkingRestrictions (default value: const {})
