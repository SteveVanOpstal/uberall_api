...
void main() {
  // final instance = ListingDetails();

  group('test ListingDetails', () {
    ...
    // List<String> mandatoryFieldsMissing (default value: const [])
    ...
    // Map<String, Object> directorySpecificData (default value: const {})
