...
void main() {
  // final instance = LocationFeatureResponse();

  group('test LocationFeatureResponse', () {
    ...
    // List<String> currentFeatures (default value: const [])
