...
void main() {
  ...
  group('test Location', () {
    ...
    // Set<Listing> listings (default value: const {})
    ...
    // Set<OpeningHours> openingHours (default value: const {})
    ...
    // Set<SpecialOpeningHours> specialOpeningHours (default value: const {})
    ...
    // Set<Label> labels (default value: const {})
    ...
    // Set<String> paymentOptions (default value: const {})
    ...
    // List<LocationPhoto> photos (default value: const [])
    ...
    // List<ServiceArea> serviceAreas (default value: const [])
    ...
    // Set<CallTrackingNumber> callTrackingNumbers (default value: const {})
    ...
    // Set<UTM> utms (default value: const {})
    ...
    // Set<LocationTransactionLink> transactionLinks (default value: const {})
    ...
    // Set<SocialProfile> socialProfiles (default value: const {})
    ...
    // List<int> contentLists (default value: const [])
    ...
    // Set<String> missingMandatoryFields (default value: const {})
    ...
    // Set<Map<String, Object>> moreHours (default value: const {})
    ...
    // Google attributes
    // List<AttributeWrapper> attributes (default value: const [])
