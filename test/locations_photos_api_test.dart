...
/// tests for LocationsPhotosApi
void main() {
  // final instance = LocationsPhotosApi();

  group('tests for LocationsPhotosApi', () {
    // Delete a Photo
    //
    // Delete a photo identified by its uberall unique id
    //
    //Future<Response> deletePhotosId(String id) async
    test('test deletePhotosId', () async {
      // TODO
    });
