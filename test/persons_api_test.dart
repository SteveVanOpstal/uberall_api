...
void main() {
  ...
  group('tests for PersonsApi', () {
    ...
    test('test deletePersonsId', () async {
      // TODO
    });
    ...
    test('test patchPersonsId', () async {
      // TODO
    });
