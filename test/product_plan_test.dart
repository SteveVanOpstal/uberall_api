...
void main() {
  // final instance = ProductPlan();

  group('test ProductPlan', () {
    ...
    // Set<String> automationDirectories (default value: const {})
    ...
    // Set<PricePerCountry> countryPrices (default value: const {})
