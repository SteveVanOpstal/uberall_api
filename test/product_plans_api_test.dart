...
/// tests for ProductPlansApi
void main() {
  // final instance = ProductPlansApi();

  group('tests for ProductPlansApi', () {
    ...
    test('test getProductPlans', () async {
      // TODO
    });
    ...
    test('test patchProductPlansId', () async {
      // TODO
    });
    ...
    test('test postProductPlans', () async {
      // TODO
    });
