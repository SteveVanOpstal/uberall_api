...
void main() {
  // final instance = UserMissingConnectionWarnings();

  group('test UserMissingConnectionWarnings', () {
    ...
    // Map<String, Object> warnings (default value: const {})
    ...
    // List<Map<String, Object>> connectedLocations (default value: const [])
    ...
    // List<Map<String, Object>> notConnectedLocations (default value: const [])
